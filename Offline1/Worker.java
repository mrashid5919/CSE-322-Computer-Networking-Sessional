                    ...
                    if(choice.equals("1")){
                        ...
                        for(Request r: requests){
                            if(r.getRequester().equals(ID)){
                                ...
                                if(!(uploads.isEmpty())){
                                        for(int i=r.getSeen();i<uploads.size();i++)
                                        {
                                            ownRequests.add(r.getID()+": "+uploads.get(i).getUploader()+" uploaded: "+uploads.get(i).getFilepath());
                                        }
                                        r.setSeen(uploads.size());
                                }
                                //Server.removeRequest(r.getID());
                            }
                            else{
                                if(r.getunSeen().contains(ID)) {
